    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
										...
										<div class="card bg-light-gray" id="new_task_card">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																			<div class="form-group">
																				...
																				<label><span class="text-danger">*</span> {{__('Task Start Date')}}:</label>
																				<div class="input-group date" id="start_date" data-target-input="nearest">
																						<input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#start_date" name="start_date" required>
														...
														<tbody>
															@foreach ($tasks as $task)
																	<tr>
																		...
																		<td>
																			<span>
																				<a class="btn btn-secondary pr-2" href="{{url('task/email/'.$task->id )}}">
																					<i class="fas fa-mail-bulk"></i>
																				</a>	
																				@can('update-lead', User::class)
																					<a class="btn btn-primary pr-2" href="#" data-toggle="modal" data-target="#editTask{{$task->id}}">
				...
				<form method="POST" action="{{url('task/update', $task)}}">
					...
					<div class="card-body">
							...
							<div class="row">
									...
									<div class="col-md-3">
											<div class="form-group">
													<label for=""><span class="text-danger">*</span> {{__('Task Start Date')}} </label>
										...
										<div class="form-group">
											<label class="cl-switch cl-switch-green">
												...
												@if ($task->is_all_day == 'yes')
													checked
												@endif>
												<span class="switcher float-left"></span>
												</label>
