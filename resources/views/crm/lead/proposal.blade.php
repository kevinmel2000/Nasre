            ...
            <div class="col-md-9">
                <div class="card card-secondary">
                    ...
                    <a type="button" class="btn btn-sm btn-primary float-right"
                        href="{{url('proposal/create/'.$relation.'/'.$lead->id)}}">{{__('New Proposal')}} </a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="#" data-toggle="tooltip" data-title="{{$product->created_at->toDayDateTimeString()}}" class="mr-2">
                                                                                    <i class="fas fa-clock text-info"></i>
                                                                                  </a>
                                                                                  <a href="#" data-toggle="tooltip" data-title="{{$product->updated_at->toDayDateTimeString()}}" class="mr-2">
                                    ...
                                    <td>
                                        ...
                                        {{@$proposal->lead->username}} | {{@$proposal->lead->email}}
                                        @endif
                                    </td>
