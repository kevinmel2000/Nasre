                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <form id="addinterestinsured">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <input type="number" min="0" max="999999999,9999" value="" step=".01" id="slipamount" name="slipamount" class="uang form-control form-control-sm " data-validation="length" data-validation-length="0-20"/>
                                                                                        </div>
                                                                                    </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 d-flex justify-content-end">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" value="" step=".0001" id="sliptotalsum" name="sliptotalsum" class="uang form-control form-control-sm " data-validation="length" data-validation-length="0-50" readonly="readonly" placeholder="tsi(*total/sum from interest insured)" />
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="0" step=".0001" id="slipnetprmtonr" name="slipnetprmtonr" class="uang form-control form-control-sm " data-validation="length" placeholder="=a%. * b% * tsi * (100% - d%)" data-validation-length="2-50" readonly="readonly"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
