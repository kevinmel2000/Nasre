                        ...
                        @foreach($slip as $slp)
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 com-sm-12 mt-3">
                                            <a type="button" href="" id="addslipsave-btn" class="btn btn-primary btn-block ">
                                                {{__('EDIT')}}
                                            </a>
                                        </div>
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 com-sm-12 mt-3">
                                            <a type="button" href="{{url()->previous()}}" id="addinsuredsave-btn" class="btn btn-primary btn-block ">
                                                {{__('BACK')}}
                                            </a>
                                        </div>
                                    </div>
