                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" hidden="false" id="sliptotalnilaiecupdate" name="sliptotalnilaiecupdate" placeholder="sum y &permil;" class="form-control form-control-sm floatTextBox2"/>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tr>
                                                                           <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="text" hidden="false" id="sliptotalpercentinspanupdate" name="sliptotalpercentinspanupdate" >
