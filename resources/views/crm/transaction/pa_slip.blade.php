  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        ...
        <form method="POST" action={{url('transaction-data/pa-slip/store')}}>
          @csrf
            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="panumber" class="form-control form-control-sm" data-validation="length" data-validation-length="1-7" disabled required/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="painsured" class="form-control form-control-sm ">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="pasuggestinsured" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" placeholder="search for insured suggestion" required/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                    <input type="text" name="pasuffix" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" placeholder="suffix: QQ or TBk" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                                <input type="text" name="pashare" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" required/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pasharefrom" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">{{__('To')}}</label>
                                                    <input type="text" name="pashareto" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pacoinsurance" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" required/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="file" name="pafile_att" id="attachment" required>  
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 d-flex justify-content-start">
                                        <div class="col-md-12 com-sm-12 mt-3">
                                            ...
                                            <table id="paFormat" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>{{__('Name')}}</th>
                                                        <th width="20%">{{__('Birth Date')}}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>{{__('John Doe')}}</td>
                                                        <td width="20%">{{__('01/01/2020')}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{__('John Doe')}}</td>
                                                        <td width="20%">{{__('31/02/2021')}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tbody>
                                                                            @foreach($extendcoveragelist as $exl)
                                                                                <tr id="iidextendcoverage{{ $exl->id }}">
                                                                                        <td>{{ @$exl->extendcoveragedata->code}} - {{ @$exl->extendcoveragedata->name}} - {{@$exl->extendcoveragedata->description }}</td>
                                                                                        <td>{{ $exl->percentage }}</td>
                                                                                        <td class="uang">@currency($exl->amount)</td>
                                                                                        <td><a href="#" onclick="deleteextendcoveragedetail({{ $exl->id }})">delete</i></a></td>
                                                                                </tr>   
                                                                            @endforeach
                                                                            <tr>
                                                                                <td >
...
@section('scripts')
@include('crm.transaction.pa_slip_js')
@endsection