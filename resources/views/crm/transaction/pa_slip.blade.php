  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        ...
        <form method="POST" id="formpainsured" action="" enctype="multipart/form-data" >
          @csrf
            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="panumber" name="panumber" class="form-control form-control-sm" value="{{ $code_ms }}" data-validation="length" data-validation-length="0-16" readonly="readonly" required/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="pasuggestinsured" name="pasuggestinsured" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="search for insured suggestion" />
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                    <input type="text" id="pasuffix" name="pasuffix" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="suffix: QQ or TBk" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="pashare" name="pashare" class="form-control form-control-sm " data-validation="length" readonly="readonly" data-validation-length="0-50" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="pacoinsurance" name="pacoinsurance" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-6 d-flex justify-content-start">
                                        <div class="col-md-12 com-sm-12 mt-3">
                                            ...
                                            <table id="paFormatTable" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>{{__('Name')}}</th>
                ...
                <div class="modal-content bg-light-gray">
                    ...
                    <form id="form-addlocation">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-info" id="addloc-btn">Add Risk Location</button>
                        </div>
                    </form>
                </div>
                </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                        <div class="input-group" id="dateinstallment">
                                                                                                <input type="date" id="dateinstallmentdata" class="form-control form-control-sm datepicker-input" data-target="#date" name="slipipdate">
