                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="slipcurrencyupdate" disabled="true" name="slipcurrencyupdate" class=" form-control form-control-sm ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="slipcobupdate" name="slipcobupdate" disabled="true" class=" form-control form-control-sm ">
                                                                @foreach($cob as $boc)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="slipkocupdate" name="slipkocupdate" disabled="true" class=" form-control form-control-sm ">
                                                                @foreach($koc as $cok)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="slipoccupacyupdate" disabled="true" name="slipoccupacyupdate"  class=" form-control form-control-sm ">
                                                                @foreach($ocp as $ocpy)
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="slipbld_constupdate" name="slipbld_constupdate" disabled="true" class=" form-control form-control-sm ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="slipbcuaupdate" name="slipbcuadetail" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="" readonly="readonly" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">{{__('Rate Lower Area')}}</label>
                                                                <input type="text" id="slipbcladupdate" name="slipbcladetail" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="" readonly="readonly" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-end">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="sliptotalsumupdate" name="sliptotalsumupdate" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" readonly="readonly" placeholder="tsi(*total/sum from interest insured)" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-end">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for=""style="opacity: 0;">{{__('Type')}}</label>
                                                                <input type="text" value="" id="sliptotalsumpctupdate" name="sliptotalsumpctupdate" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="=pct*tsi" readonly="readonly" required/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="" id="slipsumshareupdate" name="slipsumshareupdate" placeholder="= b% * tsi" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" readonly="readonly" required/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
