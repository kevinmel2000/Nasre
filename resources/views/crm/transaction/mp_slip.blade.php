                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mpsharefrom" type="number" min="0" value="0" step=".01"  name="mpsharefrom" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50"  readonly />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">{{__('Total')}}</label>
                                                    <input id="mpshareto" type="number" min="0" value="0" step=".01"  name="mpshareto" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50"  readonly/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
