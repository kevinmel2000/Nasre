                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="flnumber" value="{{$code_insured}}" class="form-control form-control-sm" data-validation="length" data-validation-length="1-7" disabled required/>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                                ...
                                                                <select name="flshare" class="form-control form-control-sm ">
                                                                        @for ($i=0; $i<=50; $i++)
