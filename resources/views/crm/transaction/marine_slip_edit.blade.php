                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tbody>
                                                                            @foreach($conditionneededtemp as $cntt)
                                                                                <tr id="cnid{{ $cntt->id }}">
                                                                                        <td data-name="{{ $cntt->condition_id }}">{{ $cntt->conditionneeded->name }} - {{ $cntt->conditionneeded->description }}</td>
                                                                                        <td data-name="{{ $cntt->information }}">
                                                                                            @if($cntt->information == null)
                                                                                                - 
                                                                                            @else
                                                                                                {{ $cntt->information }}
                                                                                            @endif
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="hidden" id="cnidupdate" value="{{ $cntt->id }}"/>
                                                                                            <a class="text-primary mr-3" id="editconditionneeded" type="button" onClick="geteditconditionneeded({{ $cntt->id }})" href="javascript:void(0)">
                                                                                                <i class="fas fa-edit"></i>
                                                                                            </a>
                                                                                            <a type="button" href="javascript:void(0)" onClick="deleteconditionneeded({{ $cntt->id }})"><i class="fas fa-trash text-danger"></i></a>
                                                                                        </td>
                                                                                </tr>   
                                                                                @endforeach
                                                                                <tr>
