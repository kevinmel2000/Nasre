                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                             <input type="number" id="feshare" min="0" step=".01" name="feshare" value="{{$insureddata->share}}"  class="form-control form-control-sm " data-validation="length" data-validation-length="0-250" required/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" value="" step=".0001" id="wpc" name="wpc" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" readonly="readonly" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
