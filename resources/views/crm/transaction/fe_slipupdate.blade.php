                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                             <input type="number" id="feshare" min="0" step=".01" name="feshare" value="{{$insureddata->share}}"  class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" readonly/>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" step=".01" id="amountlocation" name="amountlocation" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-20"/>
                                    </div>
                                </div>
                            </div>
