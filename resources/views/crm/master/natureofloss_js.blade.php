...
<script>
    $(function () {
      ...
      var kocs = <?php echo(($natureofloss_ids->content())) ?>;
    ...
    function confirmDelete(id){
        let choice = confirm("{{__('Are you sure, you want to delete this Nature Of Loss data and related data?')}}")
        if(choice){
            document.getElementById('delete-natureofloss-'+id).submit();
        }
    }
