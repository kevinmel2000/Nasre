                              ...
                              <td>
                                ...
                                <span>
                                  {{-- @can('update-country', User::class) --}}
                                    <a class="text-primary mr-3" data-toggle="modal" data-target="#updatecountry{{$boc->id}}">
                                      <i class="fas fa-edit"></i>
                                    </a>
                                  {{-- @endcan --}}

                                  <div class="modal fade" id="updatecountry{{$boc->id}}" tabindex="-1" user="dialog" aria-labelledby="updatecob{{$boc->id}}Label" aria-hidden="true">
                                    <div class="modal-dialog" user="document">
                                      <div class="modal-content bg-light-gray">
                                        <div class="modal-header bg-gray">
                                          <h5 class="modal-title" id="updateuser{{$boc->id}}Label">{{__('Update COB')}}</h5>
                                                ...
                                                <div class="row">
                                                  <div class="col-md-6 col-md-12">
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" name="codecob" class="form-control" value="{{$boc->code}}" data-validation="length" data-validation-length="1-5" required />
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="row">
