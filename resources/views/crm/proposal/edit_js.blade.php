<script>
  ...
  var proposal_relation = "{{$proposal->relation}}";
  ...
  function getLeads(){
    var proposal_lead_id = "{{$proposal->lead_id}}";
    var url="{{url('api/proposal/getLeads')}}";
    $.ajaxSetup({
      headers: {
  ...
  function getCustomers(){
    var proposal_customer_id = "{{$proposal->customer_id}}";
  ...
  function proposalProducts(){
    ...
    var url="{{url('api/proposal/getProposalProducts')}}";
    $.ajaxSetup({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
    ...
    $.ajax({
      ...
      dataType: 'JSON',
      success: function (data) { 
        row_id = data.proposal_products.length+1;
        data.proposal_products.forEach(product => {
  ...
  $('#product_id').on('change',()=>{
    ...
    var url="{{url('api/proposal/getProduct')}}";
    $.ajaxSetup({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
  ...
  // Add product in the proposal from the products list
