        ...
        if($number)
        {
            ...
            if(!empty($claimdata))
            {
                ...
                MainClaimEntryFAC::create([
                    ...
                    'date_receipt'=> date("Y-m-d", strtotime($claimdata->date_receipt)),
                    'date_document'=> date("Y-m-d", strtotime($claimdata->date_document)),
                    ...
                    'date_of_loss'=> date("Y-m-d", strtotime($claimdata->date_of_loss)),
