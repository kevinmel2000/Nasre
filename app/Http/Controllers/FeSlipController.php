...
class FeSlipController extends Controller
{
    ...
    public function indexfeslip()
    {
        ...
        $koc = Koc::where('parent_id',2)->orWhere('code', 'like',  02 . '%')->orWhere('code', 'like',  0202 . '%')->orWhere('code','02')->orderby('code','asc')->get();
    ...
    public function updatefeslip($idm)
    {
        ...
        $currency = Currency::orderby('id','asc')->get();
        $cob = COB::orderby('id','asc')->get();
        $koc = KOC::where('parent_id',2)->orWhere('code', 'like',  02 . '%')->orWhere('code', 'like',  0202 . '%')->orWhere('code','02')->orderby('id','asc')->get();
        $ocp = Occupation::orderby('id','asc')->get();
        $cedingbroker = CedingBroker::orderby('id','asc')->get();
        $ceding = CedingBroker::orderby('id','asc')->where('type',4)->get();
        $prefixinsured =  PrefixInsured::orderby('id','asc')->get();
