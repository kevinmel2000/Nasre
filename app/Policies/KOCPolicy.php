...
class KOCPolicy
{
    ...
    {
        $module = Module::select(['read', 'create', 'update', 'delete'])->where(['module_name'=>'koc_module', 'role_id'=>$user->role->id])->first();
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\MOdels\KOC  $kOC
     * @return mixed
     */
    public function view(User $user)
    {
        
        $module = Module::select(['read'])->where(['module_name'=>'koc_module', 'role_id'=>$user->role->id])->first();
    ...
    public function create(User $user)
    {
        ...
        $module = Module::select(['create'])->where(['module_name'=>'koc_module', 'role_id'=>$user->role->id])->first();
